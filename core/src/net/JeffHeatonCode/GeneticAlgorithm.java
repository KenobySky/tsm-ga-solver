...
/** GeneticAlgorithm: Implements a genetic algorithm. This is an abstract class. Other classes are provided in this book that use
 * this base class to train neural networks or provide an answer to the traveling salesman problem.
 * 
 * The genetic algorithm is also capable of using a thread pool to speed execution.
 * 
 * @author Jeff Heaton
 * @version 2.1
...
abstract public class GeneticAlgorithm<CHROMOSOME_TYPE extends Chromosome<?, ?>> {
	...
	/** What percent should be chosen to mate. They will choose partners from the entire mating population. */
	private double percentToMate;

	/** Percent of the population that the mating population chooses partners. from. */
